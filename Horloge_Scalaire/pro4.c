...
int main() {
    ...
    sleep(10);
    envoyer_message("Message du P4 -> P2: ", 5002);
    sleep(10);
    evenement_local("Local");
    sleep(10);
    envoyer_message("Message du P4 -> P3: ", 5003);
    sleep(10);
    evenement_local("Local");
    sleep(10);
    envoyer_message("Message du P4 -> P1:", 5001);
    sleep(10);
    evenement_local("Local");
    sleep(10);

    printf("Processus 4 terminé\n");
    return 0;
}
