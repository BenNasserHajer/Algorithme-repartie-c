...
int main() {
    ...
    sleep(10);
    envoyer_message("Message du P2 -> P1:", 5001);
    sleep(10);
    evenement_local("Local");
    sleep(10);
    envoyer_message("Message du P2 -> P3: ", 5003);
    sleep(10);
    evenement_local("Local");
    sleep(10);
    envoyer_message("Message du P2 ->P4: ", 5004);
    sleep(10);
    evenement_local("Local");
    sleep(10);
