...
int main() {
    ...
    sleep(10);
    envoyer_message("P3 -> P2 : ", 5002, 1);
    sleep(10);
    evenement_local("Local");
    sleep(10);
    envoyer_message("P3 -> P1 : ", 5001, 0);
    sleep(10);
    evenement_local("Local");
    sleep(10);
    envoyer_message("P3 -> P4 :  ", 5004, 3);
    sleep(10);
    evenement_local("Local");
    sleep(10);
