...
int main() {
    ...
    sleep(10);
    envoyer_message("P4 -> P2 : ", 5002, 1);
    sleep(10);
    evenement_local("Local");
    sleep(10);
    envoyer_message("P4 -> P3 :  ", 5003, 2);
    sleep(10);
    evenement_local("Local");
    sleep(10);
    envoyer_message("P4 -> P1 : ", 5001, 0);
    sleep(10);
    evenement_local("Local");
    sleep(10);
